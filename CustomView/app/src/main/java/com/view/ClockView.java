...
public class ClockView extends ImageView {
    ...
    private int widhth = 500;//控件的宽度
    private int height = 500;//控件的高度
    ...
    private void drawScale(Canvas canvas) {
        ...
        for (int i = 0; i < 12; i++) {
            if (i % 3 == 0) {//  12  3  6  9对应的线长点
                ...
                canvas.drawLine(widhth / 2, padding, widhth / 2, padding + 4 + 35, mPaint);
            } else {
                canvas.drawLine(widhth / 2, padding, widhth / 2, padding + 4 + 8, mPaint);
            }
