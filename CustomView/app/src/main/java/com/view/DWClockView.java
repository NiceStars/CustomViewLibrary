...
public class DWClockView extends ImageView {
    ...
    private int width = Utils.Dp2Px(getContext(), 280);
    private int height = Utils.Dp2Px(getContext(), 280);
    ...
    private void drawStr(Canvas canvas) {
        ...
        canvas.drawText(str, width / 2 - strW / 2, width / 2 - Utils.Dp2Px(getContext(), 70), mPaint);

        mPaint.setTextSize(30);
        mPaint.setColor(Color.BLACK);
        String str1 = "Daniel  Wellington";
        canvas.drawText(str1, width / 2 - 100, width / 2 - Utils.Dp2Px(getContext(), 50), mPaint);
